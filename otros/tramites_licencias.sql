/*--PARA SACAR LOS DATOS DE LA LICENAIA admon*/
...
--,cat_categorias.categoria as categoria_padre
--,0 as hrs_categoria
--,'0' as num_plz
,0 as hrs_licencia
...
,cat_tramite_articulos.des_motivo,tramites_licencias.fecha_sistema
,(fecha_hasta-fecha_desde)as dias_naturales
...
WHERE tramites_licencias.id_tramite_licencia=64
...
--,rh.num_plz
,x.hrs_licencia
, (p.categoria_padre||'/'||rh.hrs_categoria||'/'||rh.num_plz)as plaza
,e.fecha_ingreso,t.fecha_desde,t.fecha_hasta
,cat_tramites.descripcion_tramite,cat_tramite_articulos.num_articulo
,numero_a_letras(cat_tramite_articulos.num_articulo) as letra_articulo
,cat_tramite_articulos.des_motivo,t.fecha_sistema
,(fecha_hasta-fecha_desde)as dias_naturales
...
WHERE t.id_tramite_licencia=64


--select * from plantilla_base_administrativo_plantel limit 100