...
select 
nombre, paterno, materno,genero,fecha_nacimiento,curp,
categoria, descripcion_cat_padre,nombre_subprograma,
email_institucional, email_institucional_alias,telefono,
d_mnpio, d_ciudad, d_asenta, calle, no_ext, no_int, d_codigo

--,SUM(importe)as percepciones
,SUM(
...
and b.qnapago between 201903 and 201903
and b.desde_pag between 201903 and 201903
and hasta_pag between 201903 and 201903
