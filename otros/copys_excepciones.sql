...
(SELECT 
 ...
 TO '/var/www/html/siacbem/SIACBEM/Timbrados2/Excepciones/2018/Abril/timbrado_cfdi_Excepciones_Centavo_Abril_2018.txt'  
DELIMITER ',';

/********************************************/
COPY 
(SELECT 
 a.id_conceptos_original,a.id_conceptos,a.id_cfdi,a.clave_plaza,a.tipo_concepto,tipo,'0'||''||a.clave as clave,a.concepto,a.importe,a.importe_exento 
...
--and 
 ...
 TO '/var/www/html/siacbem/SIACBEM/Timbrados2/Excepciones/2018/Abril/timbrado_conceptos_Excepciones_Centavo_Abril_2018.txt'  
DELIMITER ',';
