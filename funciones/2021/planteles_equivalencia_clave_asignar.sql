    ...
    FOR reg IN cur LOOP
        ...
        IF(_hsm > 0) THEN
            ...
            IF(_hsm >= (reg.hrs_categoria - (reg.hrs_usadas + reg.hrs_usadas_tf))) THEN
                ...
                (_id_categoria_equivalente, _categoria_equivalente, reg.hrs_categoria, reg.hrs_usadas, (reg.hrs_categoria - (reg.hrs_usadas + reg.hrs_usadas_tf)), 2, reg.id_plantilla_base_docente_rh);
